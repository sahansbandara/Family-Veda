...
| Logo | Heart (family) + shield with cross (the safety gate). Gradient `#8BC53F` → `#1FA07E` → `#1B6BA8`. Vectors in `brand/dist/`; regenerate every icon with `brand/generate-icons.sh` |
