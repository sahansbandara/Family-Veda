...
Synthetic seed: `backend/src/Infrastructure/Persistence/Seed/SyntheticFamilySeed.cs` `[S2]`. No real NICs, no real lab PDFs.
...
- Vitals form + recorded trend display. Copy states values are shown as recorded and are not a diagnosis.
